...
if (typeof document !== "undefined") document.addEventListener("DOMContentLoaded", () => { if (!AdminAuth.requireAuth()) return; ({ invoices: initInvoices, revenue: () => initReport("revenue"), occupancy: () => initReport("occupancy"), exports: initExports, settings: initSettings })[document.body.dataset.page]?.(); });
